...
const MyChannel = () => {
  return (
    <div className="text-white">
      <div className="relative w-full h-[180px] flex items-center justify-center overflow-hidden z-[-1]">
        ...
        <label className="absolute bottom-" htmlFor="file">upload your photo</label>
      </div>
