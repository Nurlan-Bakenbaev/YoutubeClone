  ...
  return (
    <Box minHeight="95vh">
      <div className="bg-gray-500 z-10 h-[300px]" >
        <img className="flex justify-center items-center" src={channelDetail?.brandingSettings?.image.bannerExternalUrl} alt="" />
      </div>
      <ChannelCard channelDetails={channelDetail} mt="-110px" />
