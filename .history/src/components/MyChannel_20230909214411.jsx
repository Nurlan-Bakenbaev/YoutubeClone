    ...
    <div className="text-white">
      <div className="relative w-full h-[180px] flex items-center justify-center overflow-hidden z-[10]">
        ...
        <div className="absolute top-4 left-4 z-[30]">
          <label className="border px-2 py-2 rounded-lg opacity-[0.8]" htmlFor="banner"> <AttachmentIcon/> Choose Photo</label>
          <input className="hidden" id="banner" name="banner" type="file" accept="image/png, image/jpeg" />
        </div>
      </div>
