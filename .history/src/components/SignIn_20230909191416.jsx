    ...
    return (
      <div className="text-white flex gap-3 items-center">
        ...
        <button
          ...
          className="group relative w-full flex justify-center py-2 px-1 border border-transparent text-sm font-medium rounded-md text-white bg-[#ff6e40] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
        >
          <span>Sign Out</span>
        </button>
      </div>
