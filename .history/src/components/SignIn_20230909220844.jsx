        ...
        <div className=" gap-3 flex items-center ">
         <span className="hidden md:block">{login.email}</span> 
          <button
            ...
            className="rounded-full lg:rounded-md w-full py-2 px-3 border border-transparent text-sm font-medium  text-white bg-[#ff6e40] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
          >
            <span className="hidden lg:block">Sign Out</span>
            <span className="block lg:hidden  w-[20px] h-[20px]" > <ExitToAppIcon/> </span>
          </button>
        </div>
      </div>
    );
